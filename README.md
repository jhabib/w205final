...
- Have a local instance of MongoDB running and accessible on port 27017 (no passwords please); OR, have the Vagrant instance from **runnable_instance** up and port 27017 forwarded to Vagrant
